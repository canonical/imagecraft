...
This page lists the notes for past releases of Imagecraft, which summarise new features,
bug fixes and backwards-incompatible changes in each version. It also contains the
release and support policies for Imagecraft.
...
Imagecraft release naming follows the Semantic Versioning 2.0.0 scheme with
...
Imagecraft doesn't have long-term support (LTS) releases. However, we typically
deliver a compatibility release shortly after Ubuntu LTS releases to ensure
continuity.

Imagecraft software bases are derived from Ubuntu LTS releases, and their
...
.. release note template:
  ...
  Imagecraft 2.0 release notes
  ===========================

  15 October 2024

  Learn about the new features, changes, and fixes introduced in Imagecraft 2.0.


  Requirements and compatibility
  ------------------------------

  Imagecraft 2.0 requires Python 3.11 or higher.
  ...
  For development and testing, Imagecraft requires a <architecture> system or VM
  ...
  Imagecraft 2.0 brings the following features, integrations, and improvements.
  ...
  forms, such as a call to immediately perform a relevant action in Imagecraft,
  ...
  Imagecraft 2.0 brings the following minor changes.
  ...
  with the report, Imagecraft 2.0 no longer supports encryption algorithm X. As
  ...
  The following features are deprecated in Imagecraft 2.0:
  ...
  *is*. End by linking to relevant documentation, standards, or public
  ...
  The following features will be deprecated in Imagecraft <planned version>:
  ...
  cease the use of encryption algorithm X. We plan to deprecate it in Imagecraft
