...
This page lists past release notes for Imagecraft, summarising new features, bug
...
.. release note template:
  ...
  Imagecraft 1.0 requires Python 3.11 or higher.
  ...
  Imagecraft 1.0 brings the following features, integrations, and improvements.
  ...
  Imagecraft 1.0 brings the following minor changes.
  ...
  Backwards-incompatible changes in Imagecraft 1.0
  -----------------------------------------------
  ...
  with the report, Imagecraft 1.0 no longer supports encryption algorithm X. As
  ...
  Deprecated features in Imagecraft 1.0
  ------------------------------------

  The following features should no longer be used in Imagecraft 1.0, and will be
  removed in Imagecraft 1.1.
  ...
  Imagecraft 1.1. For more details about this decision and our policy, see
  ...
  The following issues have been resolved in Imagecraft 1.0:
