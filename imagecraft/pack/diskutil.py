...
def align_to_sectors(
    ...
    """
    return math.ceil(bytes_ / sector_size) * sector_size
...
def format_populate_partition(
    *,
    ...
    if fstype.value.startswith("ext"):
        return _format_populate_ext_partition(
    ...
    if "fat" in fstype.value:
        ...
        return _format_populate_fat_partition(
            fattype=fattype,
            fatsize=fatsize,
            content_dir=content_dir,
            partitionpath=partitionpath,
...
def inject_partition_into_image(
    *,
    ...
    requested_size = disk_size.sector_size * disk_size.get_sector_count()
